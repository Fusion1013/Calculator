...
class Test {
    ...
    void test() {
        ...
        out.println( calculator.readNumber(l, "10+ 45 - 3", 0) == 2);
        out.println( calculator.readNumber(l, "10+ 45 - 3", 4) == 6);
        out.println( calculator.readNumber(l, "10+ 45 - 3", 9) == 10);
        ...
        */
        ...
        stack.push("+");
         stack.push("-");
        ops = calculator.getHigherPrecedenceOps("*", stack);
        out.println( ops.toString().equals("[]"));
        */
        ...
        stack.push("(");
        stack.push("+");
        stack.push("-");  // Leading parentheses skipped
        List<String> ops = calculator.getParenthesesOps(stack);
        out.println(ops.toString().equals("[+, -]"));
        */
